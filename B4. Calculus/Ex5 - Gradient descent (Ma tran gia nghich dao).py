...
plt.xlim(1.6, 2.2)
plt.ylim(60, 150)
plt.scatter(xBar2[:, 1], y, color = "green")
...
regr.fit(xBar2, y)
slope3 = regr.coef_.flatten()[1]
bias3  = regr.coef_.flatten()[0]
print('\n    y = ', slope3, '.x + (', bias3, ')\n')


print('\n---------- Cách 4: Giải bằng công thức phương sai  ----------')
mean_x  = np.mean(x)
...
coef4       = np.array([bias4, slope4])
print('\n    y = ', slope4, '.x + (', bias4, ')\n')

print('\n---------- So sánh 3 cách giải  ----------')
print('Cách 2 (sử dụng ma trận giả ngịch đảo):', w.T.flatten())
print('Cách 3 (sử dụng scikit-learn)         :', regr.coef_.flatten())
print('Cách 4 (sử dụng công thức phương sai) :', coef4)
